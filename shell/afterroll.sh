...
_afterroll_start() {
  ...
  tmux send-keys -t "$session:Dev" "cd ~/Code/viserya/afterroll" C-m
  ...
  tmux send-keys -t "$session:DB" "cd ~/Code/viserya/afterroll" C-m

  tmux new-window -t "$session" -n "Shell"
  tmux send-keys -t "$session:Shell" "cd ~/Code/viserya/afterroll" C-m
